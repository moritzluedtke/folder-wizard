...
public class FmlSyntaxChecker {
	...
	private static final FmlSyntaxChecker instance = new FmlSyntaxChecker();

	private static final String FML_KEYWORD = "+";
	private final List<Character> legalSpecialCharacters = new ArrayList<>();
...
//				log.error("Found keyword in folder name in line: " + line);
				return false;
			}
		}
